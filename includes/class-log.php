...
if ( ! class_exists( 'Ai_Robot_Log' ) ) :
	...
	class Ai_Robot_Log {
        ...
        public function get_debug_mode() {
            if ( WP_DEBUG ) {
                return __( 'Enabled', 'ai-robot' );
            }

            return __( 'Disabled', 'ai-robot' );
        }
        ...
        public function get_xmlreader_status() {
            ...
            if ( class_exists( 'XMLReader' ) ) {
                return esc_html__( 'Yes', 'ai-robot' );
            }

            return esc_html__( 'No', 'ai-robot' );
        }
        ...
        public function get_php_version() {
            if ( version_compare( PHP_VERSION, '5.4', '<' ) ) {
                return _x( 'We recommend to use php 5.4 or higher', 'PHP Version', 'ai-robot' );
            }
            return PHP_VERSION;
        }
        ...
        public function get_memory_limit() {
            ...
            if ( $memory_limit_in_bytes_current < $memory_limit_in_bytes_required ) {
                ...
                /* translators: %1$s Memory Limit, %2$s Recommended memory limit. */
                    _x( 'Current memory limit %1$s. We recommend setting memory to at least %2$s.', 'Recommended Memory Limit', 'ai-robot' ),
                    WP_MEMORY_LIMIT,
                    $required_memory
                );
            }
