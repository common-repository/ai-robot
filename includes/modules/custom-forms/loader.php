...
if ( ! class_exists( 'Ai_Robot_Custom_Form' ) ) :

class Ai_Robot_Custom_Form extends Ai_Robot_Module {
	...
	public function load_admin() {
		if( is_admin() ) {
			...
			new Ai_Robot_Custom_Form_Admin();
		}
	}
	...
	public function register_cpt() {
		...
		register_post_type( 'ai_robot_forms', $args );
	}
