...
if ( ! class_exists( 'Ai_Robot_Loader' ) ) :

class Ai_Robot_Loader {
	...
	public function load_files( $dir, $requirements = array() ) {
		$files = scandir( AI_ROBOT_DIR . $dir );
		foreach ( $files as $file ) {
			$path = AI_ROBOT_DIR . $dir . '/' . $file;
	...
	private function init( $name ) {
		$class = 'Ai_Robot_' . $this->normalize( $name );
