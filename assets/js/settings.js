(function($){
    ...
    var AiRobotSettings = {
        ...
        /**
         * Binds events for the Ai Robot Settings.
         *
         * @since 1.0.0
         * @access private
         * @method _bind
        ...
        _bind: function()
        {
            $( document ).on('click', '.robot-save-settings', AiRobotSettings._saveSettings );
            $( document ).on('click', '.robot-vertical-tab a', AiRobotSettings._switchTabs );
        },
            ...
            $.ajax({
                ...
                .done(function ( options ) {
                    if( false === options.success ) {
                        ...
                        AiRobotSettings._displayNoticeMessage(options.data);
                    }
                });
    ...
    /**
     * Initialize AiRobotSettings
     */
    $(function(){
        AiRobotSettings.init();
    });
