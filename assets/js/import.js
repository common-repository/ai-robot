(function($){
    ...
    var AiRobotImport = {
        ...
        /**
         * Binds events for the Ai Robot Import.
         *
         * @since 1.0.0
         * @access private
         * @method _bind
        ...
        _bind: function()
        {
            $( document ).on('click', '.robot-vertical-tab a', AiRobotImport._switchTabs );
            $( document ).on('click', '.sui-checkbox-all input:checkbox', AiRobotImport._allCheckBoxes );
            $( document ).on('click', '.robot-trigger-export', AiRobotImport._triggerExport );
        },
        ...
        _triggerExport: function( event ) {
            ...
            $.ajax({
                    ...
                    dataType: 'json',
                    data : {
                        action       : 'ai_robot_trigger_export',
                        fields_data  : fields,
                ...
                .done(function ( options ) {
                    if( false === options.success ) {
                        ...
                        AiRobotImport._downloadBlob(blob);
                    }
                });
        },
