(function($){
    ...
    var AiRobot = {
        ...
        {
            // Document ready.
            $( document ).ready( AiRobot._loadPopup() );

            this._bind();
        },

        /**
         * Binds events for the Ai Robot.
         *
         * @since 1.0.0
         * @access private
         * @method _bind
        ...
        _bind: function()
        {
            $( document ).on('click', '.open-popup-link', AiRobot._openPopup );
            $( document ).on('click', '.ai-robot-select-type', AiRobot._selectType );
            $( document ).on('click', '.ai-robot-select-previous', AiRobot._selectPrevious );
            $( document ).on('click', '.robot-source', AiRobot._checkedSource );
            $( document ).on('click', '.robot-go-wizard', AiRobot._goWizard );
        ...
        _checkedSource: function( event ) {
            ...
            AiRobot.selected_source = $(this).data('source');
        ...
        _goWizard: function( ) {
            ...
            var target_url = Ai_Robot_Data.wizard_url + '&source='+ AiRobot.selected_source;
