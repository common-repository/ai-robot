<?php
$current_addon_data = ai_robot_get_addon_data('spin-rewriter');
?>
<div class="robot-box" role="document">
    ...
    <div class="robot-box-header robot-block-content-center">
        ...
        <div class="robot-dialog-image" aria-hidden="true">
            ...
            <img src="<?php echo esc_url(AI_ROBOT_URL.'/assets/images/spin-rewriter.png'); ?>" alt="<?php esc_attr_e( 'Spin Rewriter API Key', 'ai-robot' ); ?>">

        </div>

        <div class="robot-box-content integration-header">

            <h3 class="robot-box-title" id="dialogTitle2"><?php esc_html_e( 'Setup Spin Rewriter API Key', 'ai-robot' ); ?></h3>

			<span class="robot-description">
                <?php esc_html_e( 'Setup Spin Rewriter API Key to be used by Ai Robot to rewrite.', 'ai-robot' ); ?>
			</span>
    ...
    <div class="robot-box-body">
        <form class="robot-integration-form" method="post" name="robot-integration-form" action="">
            ...
            <div class="robot-form-field">
                <label class="robot-label"><?php esc_html_e( 'Email', 'ai-robot' ); ?></label>
                <div class="robot-control-with-icon">
                    <ion-icon class="robot-icon-key" name="key"></ion-icon>
                    <input name="email" placeholder="<?php esc_html_e( 'Email', 'ai-robot' ); ?>" value="<?php if(!empty($current_addon_data['email'])){echo esc_attr($current_addon_data['email']);}?>" class="robot-form-control">
                </div>
            </div>

            <div class="robot-form-field">
                <label class="robot-label"><?php esc_html_e( 'API Key', 'ai-robot' ); ?></label>
                <div class="robot-control-with-icon">
                    <ion-icon class="robot-icon-key" name="key"></ion-icon>
            ...
            <div class="robot-border-frame robot-description">
                ...
                <span>
                    <?php
                    printf(
                        esc_html__( 'Follow %1$s your Spin Rewriter API Key.', 'ai-robot' ),
