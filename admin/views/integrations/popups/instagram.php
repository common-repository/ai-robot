<?php
$current_addon_data = ai_robot_get_addon_data('instagram');
?>
<div class="robot-box" role="document">
    ...
    <div class="robot-box-header robot-block-content-center">
        ...
        <div class="robot-dialog-image" aria-hidden="true">
            ...
            <img src="<?php echo esc_url(AI_ROBOT_URL.'/assets/images/instagram-sketched.png'); ?>" alt="<?php esc_attr_e( 'Instagram SessionID', 'ai-robot' ); ?>">

        </div>

        <div class="robot-box-content integration-header">

            <h3 class="robot-box-title" id="dialogTitle2"><?php esc_html_e( 'Setup Instagram SessionID', 'ai-robot' ); ?></h3>

			<span class="robot-description">
                <?php esc_html_e( 'Setup Instagram SessionID to be used by Auto Instagram to display feeds on your blog.', 'ai-robot' ); ?>
			</span>
        ...
        <form class="robot-integration-form" method="post" name="robot-integration-form" action="">
            ...
            <div class="robot-form-field">
                ...
                <div class="robot-control-with-icon">
                    ...
                    <input name="session_id" placeholder="<?php esc_html_e( 'Session ID', 'ai-robot' ); ?>" value="<?php if(!empty($current_addon_data['session_id'])){echo esc_attr($current_addon_data['session_id']);}?>" class="robot-form-control">
                </div>
            </div>
            ...
            <div class="robot-border-frame robot-description">
                ...
                <span>
                    <?php
                    printf(
                        esc_html__( 'Follow %1$s your Instagram SessionID.', 'ai-robot' ),
