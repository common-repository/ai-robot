<?php
$current_addon_data = ai_robot_get_addon_data('facebook');
?>
<div class="robot-box" role="document">
    ...
    <div class="robot-box-header robot-block-content-center">
        ...
        <div class="robot-dialog-image" aria-hidden="true">
            ...
            <img src="<?php echo esc_url(AI_ROBOT_URL.'/assets/images/facebook.png'); ?>" alt="<?php esc_attr_e( 'Facebook API', 'ai-robot' ); ?>">

        </div>

        <div class="robot-box-content integration-header">

            <h3 class="robot-box-title" id="dialogTitle2"><?php esc_html_e( 'Setup Facebook API', 'ai-robot' ); ?></h3>

			<span class="robot-description">
                <?php esc_html_e( 'Setup Facebook API to be used by Ai Robot to display tweets on your blog.', 'ai-robot' ); ?>
			</span>
