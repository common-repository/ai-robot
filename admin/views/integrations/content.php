<div class="robot-row-with-sidenav">
    ...
    <div class="robot-sidenav">
        <div class="robot-mobile-select">
            <span class="robot-select-content"><?php esc_html_e( 'API Settings', 'ai-robot' ); ?></span>
        ...
        <ul class="robot-vertical-tabs robot-sidenav-hide-md">
            ...
            <li class="robot-vertical-tab current">
                <a href="#" data-nav="robot-apps"><?php esc_html_e( 'API Settings', 'ai-robot' ); ?></a>
            </li>

            <li class="robot-vertical-tab">
                <a href="#" data-nav="robot-others"><?php esc_html_e( 'More APIs', 'ai-robot' ); ?></a>
            </li>
