...
if ( ! class_exists( 'Ai_Robot_Admin_Module' ) ) :

abstract class Ai_Robot_Admin_Module {
	...
	/**
	 * Ai_Robot_Admin_Module constructor.
	 *
	 * @since 1.0
	 */
	public function __construct() {
		...
		add_filter( 'ai_robot_data', array( $this, 'add_js_defaults' ) );
		add_filter( 'ai_robot_l10n', array( $this, 'add_l10n_strings' ) );
