...
if ( ! class_exists( 'Ai_Robot_Welcome_Page' ) ) :

	class Ai_Robot_Welcome_Page extends Ai_Robot_Admin_Page {
        /**
        ...
        public function enqueue_scripts( $hook ) {
        	...
        	// Load admin scripts
        	ai_robot_admin_enqueue_scripts_welcome(
            	AI_ROBOT_VERSION,
